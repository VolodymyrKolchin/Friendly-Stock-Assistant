    ...
    return (
        <Panel>
            ...
            columns={[
                ...
                { header: 'Cost', hash: 'cost_price', render: ({ price }) => renderPrice(price), isSortable: true},
                { header: 'Profit, %', hash: 'cost_price', render: ({ price }) => renderPrice(price), isSortable: true},
            ]}
            items={tableItems}
            itemName="Products"
            pagination={{
